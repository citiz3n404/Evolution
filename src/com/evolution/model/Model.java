...
public class Model implements Observable, CONSTANTS{
    ...
    /**
     * Create an arrayList with all the squares in the created world,
     * this method is mainly used for le placement of animals
     * doing a random without "remise"
     */
    ...
    /**
     * Methods that create animals using square list created by initSquarePossibilities
     * it use a random number to select the square of each animal and then 
     * remove de square in the list to don't allow animal to be on another one
     */
    ...
    /**
     * This methods was only for debugging, it print to the console the number of 
     * animal per square
     * @deprecated 
     */
    ...
    /**
     * This method do a move, a birthday, a meal and baby if it's possible
     * on all the list of animals
     */
